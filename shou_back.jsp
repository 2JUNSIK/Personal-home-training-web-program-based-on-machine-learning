					...
					<div class="col-12">
						<div class="content">
							...
							<article class="box page-content">
								...
								<header>
									<h2 style="font-size: 40px;text-align: center; margin-bottom: 2%;">등 & 어깨 운동 리스트</h2>
									<p style="font-size: 20px;text-align: center;">아직도 <b style="font-size:25px; color: #f50057;">어깨</b> 접고다니십니까? <b style="font-size:25px; color: #009688;">이루어Gym</b> 그 <b style="font-size:25px; color: #f50057;">어깨</b> 한없이 펴드립니다.</p>
								</header>
								...
								<section>
									...
									<section text-align="center">
										...
										<%
											ArrayList<WorkOutDTO> arr = (ArrayList<WorkOutDTO>) session.getAttribute("shou_backList");
											if (arr == null) {
										%>
										<h1>db에 아직 안담김</h1>
										<%
