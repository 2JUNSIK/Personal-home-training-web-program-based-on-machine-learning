					...
					<div class="col-12">
						<div class="content">
							...
							<article class="box page-content">
										...
										<header>
									<h2 style="font-size: 40px;text-align: center; margin-bottom: 2%;">다리 운동 리스트</h2>
									<p style="font-size: 20px;text-align: center;"> 남자는 <b style="font-size:25px; color: #f50057;">하체힘!</b> 여자는 <b style="font-size:25px; color: #f50057;">각선미!</b> </p>
								</header>
								...
								<section>
									...
									<section text-align="center">
										...
										<%
											ArrayList<WorkOutDTO> arr = (ArrayList<WorkOutDTO>) session.getAttribute("legList");
											if (arr == null) {
										%>
										<h1>db에 아직 안담김</h1>
										<%
