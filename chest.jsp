					...
					<div class="col-12">
						<div class="content">
							...
							<article class="box page-content">
								<header>
									<h2 style="font-size: 40px;text-align: center; margin-bottom: 2%;">가슴 운동 리스트</h2>
									<p style="font-size: 20px;text-align: center;"><b style="color:#009688; font-size: 25px;">이루어Gym</b>과 함께라면 태평양같은 <b style="font-size:25px; color: #f50057;">가슴</b>은 한 달만에 이루어집니다. </p>
								</header>
								...
								<section>
									...
									<section text-align="center">
										...
										<%
											ArrayList<WorkOutDTO> arr = (ArrayList<WorkOutDTO>) session.getAttribute("chestList");
											if (arr == null) {
										%>
										<h1>db에 아직 안담김</h1>
										<%
